...
def house_scrap() :
                ...
                for page_num in range(1, num_pages + 1):
                    ...
                    # price = ''.join(filter(str.isdigit, price_text))
                        ...
                        details_url = house.find('a', {'class': 'tooltip-toggle'})['href']
                    ...
                    #    contact_element = details_soup.find('div', {'class': 'col-md-12 col-xs-12 col-sm-12 block-2  '}).find('i', {'class': 'fa fa-phone'})
